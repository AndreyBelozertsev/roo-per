...
/**
 * Class ArticleCategoryThumbnailAttachment
 * @package Portal\ContentBundle\Entity
 *
 * @ORM\Table(name="article_category_thumbnail_attachment")
 * @ORM\Entity(repositoryClass="Portal\ContentBundle\Repository\ArticleCategoryThumbnailAttachmentRepository")
 * @ORM\HasLifecycleCallbacks
 */
class ArticleCategoryThumbnailAttachment extends Attachment
{
    /**
     * @var int
     *
    ...
    /**
     * @ORM\OneToOne(targetEntity="ArticleCategory", inversedBy="thumbnail_attachment")
