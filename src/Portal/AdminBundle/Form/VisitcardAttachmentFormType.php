...
use Portal\ContentBundle\Entity\VisitcardAttachment;
use Vich\UploaderBundle\Form\Type\VichImageType;

class VisitcardAttachmentFormType extends AbstractType
{
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults([
            'data_class' => VisitcardAttachment::class,
    ...
    {
        return 'admin_visitcard_attachment';
    }
}
